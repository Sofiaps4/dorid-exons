...
The resulting gene trees were used as input for removing outliers with phylTer, run in R, using the following code [phylTER](https://github.com/Sofiaps4/dorid-exons/blob/main/assemble%20and%20extracting%20genes/phylTER.R). Resulted outliers were removed from the initial retrieved data using [filter_outliers](https://github.com/Sofiaps4/dorid-exons/blob/main/assemble%20and%20extracting%20genes/filter_outliers.py). These filtered retrieved genes were used for further [phylogenetic](https://github.com/Sofiaps4/dorid-exons/tree/main/phylogeny) and [capture efficiency](https://github.com/Sofiaps4/dorid-exons/tree/main/efficiency_analyses) analyses. 
